import { Dependable, IDependable } from './dependency.ts';
import { MetadataEntry } from './metadata.ts';
import { captureStackTrace } from './private/stack-trace.ts';
import { addressOf } from './private/uniqueid.ts';
